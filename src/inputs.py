...
logger = logging.getLogger("ResidentAssignmentApp")

parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter)
parser.add_argument("--grid", help="path of the csv file with the resident availability", type=Path,
                    default="data/grid.csv", nargs='+')
parser.add_argument("--newPeriod", help="path of the csv file with the resident assignment for previous months",
...
parser.add_argument("--livercost", help="fixed OB pain per month", type=int, default=5)
